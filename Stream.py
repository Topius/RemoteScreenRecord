...
# Define the streaming server URL
STREAM_URL = 'rtmp://your-streaming-server-url'
...
def record_screen(duration, counter):
    ...
    while True:
        ...
        # Stream the frame to the streaming server
        stream_frame(STREAM_URL, frame)
...
# Function to stream a frame to the streaming server
def stream_frame(stream_url, frame):
